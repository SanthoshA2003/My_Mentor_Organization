  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        {can("create_job") && <Button data-testid="new-job-btn" onClick={() => navigate("/jobs/new")} className="bg-[#1e5bff] hover:bg-[#154cdb] transition-colors duration-200"><Plus className="h-4 w-4 mr-2" /> New Job Description</Button>}
      </div>
